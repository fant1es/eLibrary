...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.register_brn = QtWidgets.QPushButton(parent=self.horizontalWidget_3)
        self.register_brn.setMinimumSize(QtCore.QSize(0, 70))
        self.register_brn.setObjectName("register_brn")
        self.horizontalLayout_3.addWidget(self.register_brn)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.register_brn.setText(_translate("MainWindow", "Регистрация"))
